    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      ...
      <section className="flex flex-col items-center justify-center text-center px-6 py-24 bg-background">
        ...
        <div className="flex gap-4 flex-wrap justify-center">
          ...
          <a href="#features" className="border border-slate-600 hover:border-cyan-400 text-muted-foreground hover:text-cyan-400 font-semibold px-8 py-3 rounded-xl text-sm transition">Learn More</a>
        </div>
      </section>
      <section id="features" className="px-6 py-20 max-w-6xl mx-auto w-full">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            <div key={f.title} className="bg-background border border-border/50 rounded-2xl p-6 hover:border-cyan-500/40 transition">
      ...
      <section className="px-6 py-20 bg-background w-full">
      ...
      <section className="px-6 py-16 text-center max-w-3xl mx-auto">
        <div className="bg-background border border-cyan-500/20 rounded-2xl p-8">
          <div className="text-4xl mb-4">💰</div>
          <h2 className="text-2xl font-bold mb-3">Postpaid. No Upfront Cost.</h2>
          <p className="text-muted-foreground text-sm leading-relaxed">We operate on a postpaid model. No upfront payment required. You are charged a fixed monthly fee per active trading bot, billed at the end of each month. Stop anytime, no strings attached.</p>
        </div>
      </section>
      <section className="px-6 py-20 text-center">
        <h2 className="text-3xl font-bold mb-4">Ready to Automate?</h2>
        <p className="text-muted-foreground mb-8 max-w-xl mx-auto">Join AlgoMomentum and let your strategies run while you sleep. Powered by Delta Exchange India.</p>
      ...
      <footer className="bg-background border-t border-border/60 px-6 py-10 mt-auto">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              <h4 className="text-muted-foreground font-semibold text-sm mb-3">Platform</h4>
            ...
            <div>
              <h4 className="text-muted-foreground font-semibold text-sm mb-3">Legal</h4>
              <ul className="space-y-2 text-slate-500 text-xs">
            ...
            <div>
              <h4 className="text-muted-foreground font-semibold text-sm mb-3">Company</h4>
              <ul className="space-y-2 text-slate-500 text-xs">
