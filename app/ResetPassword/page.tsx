        ...
        <div className="bg-white rounded-2xl p-8 shadow-xl">
          {done ? (
            <div className="text-center space-y-4">
              ...
              <h2 className="text-xl font-bold text-[#1E3A5F]">Password Reset!</h2>
              <p className="text-gray-500 text-sm">Your password has been updated. You can now sign in with your new password.</p>
              <button onClick={() => router.push("/Signup")}
                className="w-full bg-[#1E3A5F] text-white py-3 rounded-xl font-semibold text-sm hover:bg-[#152c4a] transition">
                Go to Sign In
              </button>
            </div>
          ) : (
            <div className="space-y-4">
              <div>
                <h2 className="text-xl font-bold text-[#1E3A5F]">Reset Password</h2>
