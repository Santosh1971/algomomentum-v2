        ...
        <div className="bg-white rounded-2xl p-8 shadow-xl">
          {sent ? (
            <div className="text-center space-y-4">
              ...
              <h2 className="text-xl font-bold text-[#161B22]">Check your email</h2>
              ...
              <button onClick={() => router.push("/Signup")} className="text-[#161B22] text-sm font-medium hover:underline">
                Back to Sign In
              </button>
            </div>
          ) : (
            <div className="space-y-4">
              <div>
                <h2 className="text-xl font-bold text-[#161B22]">Forgot Password</h2>
              ...
              <button onClick={() => router.push("/Signup")} className="w-full text-center text-gray-500 text-sm hover:text-[#161B22]">
                Back to Sign In
              </button>
            </div>
          )}
